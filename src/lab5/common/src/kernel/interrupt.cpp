...
void (*final_time_interrupt_handler)() = nullptr;

extern "C" void c_time_interrupt_handler() {
	if (final_time_interrupt_handler) {
		final_time_interrupt_handler();
	}
}

void InterruptManager::setCustomTimeInterrupt(void (*handler)()) {
	final_time_interrupt_handler = handler;
}
